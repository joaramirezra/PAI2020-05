...
class serialPlot:
    ...
    def getSerialData(self, frame, lines, lineValueText, lineLabel, timeText, pltNumber):
        ...
        timeText.set_text('Tiempo de muestreo = ' + str(self.plotTimer) + 'ms')
...
def main():
    ...
    lineLabelText = ['Diferencia de presion', 'Presion Oxigeno', 'Presion Inhalatoria']
    title = ['Volumen Tidal', 'Presion oxigeno', 'Presion inhalatoria']
    xLimit = [(0, maxPlotLength), (0, maxPlotLength), (0, maxPlotLength)]
    yLimit = [(-1, 1), (-0.5, 20), (-1, 3)]
